...
payload patterns participate only when the checker can prove full constructor
coverage safely; unsupported or infinite domains produce no static coverage
claim.

These diagnostics do not change default Nulang 1.x program validity. Coverage
