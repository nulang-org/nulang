...
exist. On the initial source merge, that means the previous successful
production deployment stays live while Docs Sync prepares the generated-assets
PR. Once that PR passes branch protection and is merged, Cloudflare deploys the
homepage and compiler bundle together.
