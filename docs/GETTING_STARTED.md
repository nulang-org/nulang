...
nulang nula build              # resolve deps + build bytecode package artifact
nulang nula build --target wasm   # portable package WASM in .nula/dist/
nulang nula build --target cwasm  # portable WASM + Wasmtime AOT sidecar
