...
| `W0201` | Provably non-exhaustive finite-variant `match` | Add arms for the reported missing constructor witnesses |
| `W0202` | Redundant/unreachable finite-variant match arm | Remove, move, or refine the reported arm(s) |
