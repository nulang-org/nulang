...
mod simd_compiler_tests {
    ...
    fn test_simd_i64x2_compiles() {
        ...
        let ptr = compile_simd_region(
            &mut jit.codegen.optimized_module,
            &mut jit.codegen.optimized_builder_context,
            &mut jit.codegen.optimized_ctx,
            "test_simd_i64x2",
            &instructions,
            &region,
        );
    ...
    fn test_simd_sub_and_mul() {
        ...
        let ptr2 = compile_simd_region(
            &mut jit2.codegen.optimized_module,
            &mut jit2.codegen.optimized_builder_context,
            &mut jit2.codegen.optimized_ctx,
            "test_simd_mul",
            &instructions,
            &mul_region,
        );
