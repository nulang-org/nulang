...
/// Whether `pc` belongs to an analysis window whose entry uses a
/// compiler-owned type seed. Queried only at tier-up to decide whether the
/// resulting typed region needs a live representation guard.
