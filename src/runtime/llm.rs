...
pub(crate) fn resume_suspended_llm_step(rt: &mut Runtime, actor_id: u64) {
    ...
    crate::runtime::workflow::resume_workflow_activation(rt, actor_id, suspended.activation);
    ...
    unsafe {
        ...
        crate::runtime::workflow::clear_workflow_activation(&mut *self_ptr, actor_id);
