...
pub const MOBILE_UI_PROTOCOL: &str = "nulang-ui/1";
pub const MOBILE_MESSAGE_PROTOCOL: &str = "nulang-ui-msg/1";
...
mod tests {
    ...
    fn manifest_pins_protocols_formats_and_interpreter_runtime() {
        ...
        assert_eq!(manifest.ui_protocol, "nulang-ui/1");
        assert_eq!(manifest.message_protocol, "nulang-ui-msg/1");
        assert_eq!(
            manifest.callbacks,
            vec![
