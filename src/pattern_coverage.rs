...
//!
//! Coverage findings are warnings rather than new hard type errors in this first
//! stabilization slice. Projects that want strict matching can opt into the
//! existing `--deny-warnings` policy while the analyzer expands beyond finite
//! top-level variants and booleans.
