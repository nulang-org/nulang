        ...
        StdLib {
            ops: vec![
                ...
                BuiltinOp {
                    ...
                    effect: "Secret",
                    op: "get",
                    signature: "get(name: String) -> Secret[String]",
                    implemented_in: ImplSite::RuntimeHost,
                    description: "Issue an actor-scoped opaque handle for a named secret; does not load secret plaintext into the VM.",
                },
                BuiltinOp {
                    name: "Secret.read",
                    effect: "Secret",
                    op: "read",
                    signature: "read(name: String) -> Secret[String]",
                    implemented_in: ImplSite::RuntimeHost,
                    description: "Alias of Secret.get; returns an opaque checked handle, not secret plaintext.",
                },
                BuiltinOp {
                    name: "Secret.valid",
                    effect: "Secret",
                    op: "valid",
                    signature: "valid(secret: Secret[T]) -> Bool",
                    implemented_in: ImplSite::RuntimeHost,
                    description: "Return whether a secret handle is live and owned by the current actor.",
                },
                BuiltinOp {
                    name: "Secret.revoke",
                    effect: "Secret",
                    op: "revoke",
                    signature: "revoke(secret: Secret[T]) -> Bool",
                    implemented_in: ImplSite::RuntimeHost,
                    description: "Invalidate a secret handle owned by the current actor.",
                },
                BuiltinOp {
                    name: "Env.get",
                    effect: "Env",
