    ...
    pub fn new() -> Self {
        StdLib {
            ops: vec![
                ...
                BuiltinOp {
                    name: "Compute.default_device",
                    effect: "Compute",
                    op: "default_device",
                    signature: "default_device() -> Device",
                    implemented_in: ImplSite::RuntimeHost,
                    description: "Resolve the runtime's default compute device. Actor-backed calls require Compute::Use(auto) authority.",
                },
                BuiltinOp {
                    name: "Compute.device",
                    effect: "Compute",
                    op: "device",
                    signature: "device(name: String) -> Device",
                    implemented_in: ImplSite::RuntimeHost,
                    description: "Resolve an opaque accelerator device handle by provider-neutral name or 'auto'.",
                },
                BuiltinOp {
                    name: "Compute.device_name",
                    effect: "Compute",
                    op: "device_name",
                    signature: "device_name(device: Device) -> String",
                    implemented_in: ImplSite::RuntimeHost,
                    description: "Return the canonical name of an already-resolved compute device.",
                },
                BuiltinOp {
                    name: "Tensor.from_array",
                    effect: "Tensor",
                    op: "from_array",
                    signature: "from_array(values: [Float], rows: Int, cols: Int) -> Tensor[Float]",
                    implemented_in: ImplSite::StandaloneVm,
                    description: "Create a rank-2 floating tensor using the deterministic CPU reference semantics.",
                },
                BuiltinOp {
                    name: "Tensor.zeros",
                    effect: "Tensor",
                    op: "zeros",
                    signature: "zeros(rows: Int, cols: Int) -> Tensor[Float]",
                    implemented_in: ImplSite::StandaloneVm,
                    description: "Create a zero-filled rank-2 floating tensor.",
                },
                BuiltinOp {
                    name: "Tensor.shape",
                    effect: "Tensor",
                    op: "shape",
                    signature: "shape(tensor: Tensor[T]) -> [Int]",
                    implemented_in: ImplSite::StandaloneVm,
                    description: "Return the runtime shape of a tensor.",
                },
                BuiltinOp {
                    name: "Tensor.to_array",
                    effect: "Tensor",
                    op: "to_array",
                    signature: "to_array(tensor: Tensor[Float]) -> [Float]",
                    implemented_in: ImplSite::StandaloneVm,
                    description: "Materialize a floating tensor into row-major host values.",
                },
                BuiltinOp {
                    name: "Tensor.add",
                    effect: "Tensor",
                    op: "add",
                    signature: "add(lhs: Tensor[Float], rhs: Tensor[Float]) -> Tensor[Float]",
                    implemented_in: ImplSite::StandaloneVm,
                    description: "Elementwise tensor addition with exact shape equality.",
                },
                BuiltinOp {
                    name: "Tensor.matmul",
                    effect: "Tensor",
                    op: "matmul",
                    signature: "matmul(lhs: Tensor[Float], rhs: Tensor[Float]) -> Tensor[Float]",
                    implemented_in: ImplSite::StandaloneVm,
                    description: "Rank-2 matrix multiplication using the reference tensor contract.",
                },
                BuiltinOp {
                    name: "Tensor.relu",
                    effect: "Tensor",
                    op: "relu",
                    signature: "relu(input: Tensor[Float]) -> Tensor[Float]",
                    implemented_in: ImplSite::StandaloneVm,
                    description: "Apply ReLU elementwise.",
                },
                BuiltinOp {
                    name: "Http.get",
                    effect: "Http",
