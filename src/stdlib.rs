        ...
        StdLib {
            ops: vec![
                ...
                BuiltinOp {
                    ...
                    effect: "ArrayBuilder",
                    op: "new",
                    signature: "new() -> ArrayBuilder[T]",
                    implemented_in: ImplSite::StandaloneVm,
                    description: "Create an empty mutable generic array builder.",
                },
                BuiltinOp {
                    name: "ArrayBuilder.push",
                    effect: "ArrayBuilder",
                    op: "push",
                    signature: "push(b: ArrayBuilder[T], value: T) -> ArrayBuilder[T]",
                    implemented_in: ImplSite::StandaloneVm,
                    description: "Append one value with amortized O(1) growth; rebind the returned builder.",
                },
                BuiltinOp {
                    name: "ArrayBuilder.len",
                    effect: "ArrayBuilder",
                    op: "len",
                    signature: "len(b: ArrayBuilder[T]) -> Int",
                    implemented_in: ImplSite::StandaloneVm,
                    description: "Return the number of initialized builder elements.",
                },
                BuiltinOp {
                    name: "ArrayBuilder.to_array",
                    effect: "ArrayBuilder",
                    op: "to_array",
                    signature: "to_array(b: ArrayBuilder[T]) -> [T]",
                    implemented_in: ImplSite::StandaloneVm,
                    description: "Materialize initialized builder elements into a canonical immutable array.",
                },
                BuiltinOp {
                    name: "ArrayBuilder.reset",
                    effect: "ArrayBuilder",
                    op: "reset",
                    signature: "reset(b: ArrayBuilder[T]) -> ArrayBuilder[T]",
                    implemented_in: ImplSite::StandaloneVm,
                    description: "Release initialized elements and reset the builder to length zero while retaining capacity.",
                },
                BuiltinOp {
                    name: "StrBuilder.new",
                    effect: "StrBuilder",
