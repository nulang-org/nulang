        ...
        StdLib {
            ops: vec![
                ...
                BuiltinOp {
                    ...
                    implemented_in: ImplSite::StandaloneVm,
                    description: "Create an empty mutable array-construction buffer.",
                },
                BuiltinOp {
                ...
                BuiltinOp {
                    ...
                    implemented_in: ImplSite::StandaloneVm,
                    description: "Return the number of initialized elements in the builder.",
                },
                BuiltinOp {
                    ...
                    implemented_in: ImplSite::StandaloneVm,
                    description: "Materialize initialized elements as a canonical immutable array.",
                },
                BuiltinOp {
                    name: "StrBuilder.new",
                    effect: "StrBuilder",
