...
pub trait ActorVmCallbacks: std::any::Any + std::fmt::Debug {
    ...
    /// Create a constant-size zero-copy slice view. Nested views are flattened
    /// to the ultimate backing Array.
    fn array_slice(&mut self, ptr: *mut u8, start: usize, end: usize) -> Value {
        ...
        unsafe {
            ...
            // The view owns exactly one reference to its backing Array.
