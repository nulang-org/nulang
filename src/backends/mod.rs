...
///
/// These counters intentionally measure compiler wall time only. They do not
/// include interpretation before tier-up or execution of the generated code,
/// so benchmark harnesses can report compile latency separately from runtime
/// payoff.
