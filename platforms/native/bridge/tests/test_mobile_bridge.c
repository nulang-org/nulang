...
const char *nulang_mobile_action_runtime_invoke(
    ...
    if (strstr(request_json, "\"action_id\":\"action_bridge_save\"") == NULL) {
    ...
    snprintf(
        ...
        "%s",
        "{\"type\":\"patch\",\"protocol\":\"nulang-ui-msg/1\","
        "\"patch\":{\"protocol\":\"nulang-ui/1\","
        "\"document_id\":\"doc-bridge\",\"base_revision\":\"7\","
        "\"revision\":\"8\",\"operations\":[]}}"
    );
    runtime->last_error = NULL;
...
int main(void) {
    ...
    static const char authorized_request[] =
        "{\"type\":\"invoke_action\",\"protocol\":\"nulang-ui-msg/1\","
        "\"request\":{\"document_id\":\"doc-bridge\",\"revision\":\"7\","
        "\"action_id\":\"action_bridge_save\",\"placement\":\"client\","
        "\"correlation_id\":\"corr-bridge\",\"idempotency_key\":\"idem-bridge\","
        "\"payload\":{\"type\":\"null\"}}}";
    static const char unauthorized_request[] =
        "{\"type\":\"invoke_action\",\"protocol\":\"nulang-ui-msg/1\","
        "\"request\":{\"document_id\":\"doc-bridge\",\"revision\":\"7\","
        "\"action_id\":\"action_unknown\",\"placement\":\"client\","
        "\"correlation_id\":\"corr-bridge\",\"idempotency_key\":\"idem-bridge-2\","
        "\"payload\":{\"type\":\"null\"}}}";
    ...
    assert(strstr(action_result, "nulang-ui-msg/1") != NULL);
    assert(strstr(action_result, "\"type\":\"patch\"") != NULL);
    assert(strstr(action_result, "doc-bridge") != NULL);
