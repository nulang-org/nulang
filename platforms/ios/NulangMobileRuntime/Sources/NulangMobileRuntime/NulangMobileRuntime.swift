...
public final class NulangMobileRuntime: @unchecked Sendable {
    ...
    /// Execute one compiler-authorized canonical `nulang-ui-msg/1`
    ...
    /// while still holding the runtime lock. It does not decode the returned
    /// canonical snapshot/patch; protocol validation already occurs in Rust
    /// and semantic message handling belongs to the UI host above this layer.
