...
- **Perf: capability-driven readonly JIT loads** (`src/jit/typed_compiler.rs`, `src/mir_codegen.rs`): array loads from `val`-capability data compile with readonly memory flags.
