# RFC 0024: Pattern Coverage Diagnostics
...
match arm typechecking succeeds, the frontend runs finite-domain coverage
analysis and appends `W0201/W0202` to its semantic warning stream.
